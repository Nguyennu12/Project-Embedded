...
void initGPIO(void) {
	...
	GPIO_PinInit(GPIOD, 7, &pin_config_in);
	GPIO_PinInit(GPIOE, 0, &pin_config_in);
	GPIO_PinInit(GPIOE, 1, &pin_config_in);
	GPIO_PinInit(GPIOE, 2, &pin_config_in);
	GPIO_PinInit(GPIOE, 8, &pin_config_in);
...
void readDirection(void){
	...
	if (value != oldDirection)
	{
		...
		switch (value)
		{
			case 0b00011111: /* Stop DC motor */
							motorDCStop();
							break;
			case 0b00011011: /* Ko lech */
				FTM_UpdatePwmDutycycle(FTM0, kFTM_Chnl_0, kFTM_CenterAlignedPwm, 7);
				FTM_SetSoftwareTrigger(FTM0, true);
				break;
			case 0b00011001: /* Lech phai 1 */
				FTM_UpdatePwmDutycycle(FTM0, kFTM_Chnl_0, kFTM_CenterAlignedPwm, 6);
				FTM_SetSoftwareTrigger(FTM0, true);
				break;
			case 0b00011100: /* Lech phai 2 */
			case 0b00011110: /* Lech phai 2 */
				FTM_UpdatePwmDutycycle(FTM0, kFTM_Chnl_0, kFTM_CenterAlignedPwm, 5);
				FTM_SetSoftwareTrigger(FTM0, true);
				break;

			case 0b00010011: /* Lech trai 1 */
				FTM_UpdatePwmDutycycle(FTM0, kFTM_Chnl_0, kFTM_CenterAlignedPwm, 9);
				FTM_SetSoftwareTrigger(FTM0, true);
				break;
			case 0b00000111: /* Lech trai 2 */
			case 0b00001111: /* Lech trai 2 */
				FTM_UpdatePwmDutycycle(FTM0, kFTM_Chnl_0, kFTM_CenterAlignedPwm, 10);
				FTM_SetSoftwareTrigger(FTM0, true);
				break;
}
	}
